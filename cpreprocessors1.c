...
#include"ctypecasting.c" //we're including another file to this file
//as we've included ctypecasting.c file into this program file, in this 
//ctypecasting.c file there is main() method so while we're running this
//program change that "main" method of ctypecasting.c file doing "main2" 
//method
int main()
{
    int b=5;
...
//we can also use all the functions or variables which is used in that 
//imported file to this program file
